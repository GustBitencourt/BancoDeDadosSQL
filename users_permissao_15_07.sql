...
EXPLAIN SELECT `nome` FROM `cancoes` WHERE `nome` = "Be Yourself";
...
UPDATE LOW_PRIORITY `cancoes` SET `nome` = "Crazy"
...
CREATE USER "gustavo"@"localhost" IDENTIFIED BY "ctd2021";
CREATE USER "larissa"@"localhost" IDENTIFIED BY "ctd20211";
CREATE USER "fernando"@"localhost" IDENTIFIED BY "ctd20212";
